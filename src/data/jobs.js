...
const data = [
  {
    ...
    tasks: [
      ...
      "Collaboration inter-équipes pour garantir le respect des standards météo (norme OGC)",
  ...
  },
  {
    ...
    description: `Dans le cadre de la refonte du site app.linkeys.com, j'ai implémenté la nouvelle architecture afin d'améliorer l'expérience utilisateur et la maintenabilité du site.`,
    tasks: [
      "Participation aux choix d'architecture et leurs développements sur Aws",
