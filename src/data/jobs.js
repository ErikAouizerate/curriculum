...
const data = [
  {
    ...
    description: `Implémentation de l'authentification Single Sign-On (SSO) multi-providers`,
    tasks: [
      "Développement de l'intégration OAuth 2.0 avec les providers Google, Facebook et Apple",
      "Récupération et mapping des données utilisateur via les APIs respectives (Google People API, Facebook Graph API, Apple ID)",
      "Implémentation de la logique de fusion des paniers anonymes avec les comptes utilisateur authentifiés",
      "Intégration avec l'API commercetools pour la synchronisation des données e-commerce",
      "Gestion des tokens d'accès et de rafraîchissement selon les standards de sécurité OAuth 2.0",
    ],
    tools: [
      labels.typescript,
      labels.fastify,
  ...
  },
  {
    ...
    title: "Développeur backend à Pretto – Paris – ",
    description: `Refactorisation complète du microservice de gestion de rendez-vous et synchronisation multi-calendriers`,
    tasks: [
  ...
  },
  {
    ...
    tasks: [
      ...
      "Création d'un serveur Node d'authentification auprès de Keycloak et Wso2 avec le protocole OAuth2",
  ...
  },
  {
    ...
    tasks: [
      ...
      "Implémentation de l’authentification unique (SSO) via Google en utilisant OAuth2 / OpenID Connect",
    ],
    tools: [
      labels.typescript,
      labels.nextjs,
